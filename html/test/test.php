...
<script>
	...
	let questions = [
		...
		if ($_GET["type"]=="iq") {?>
	        ["What is ten to the power of three minus one? (Use PEMDAS)",99,100,999,27],
	        ...
	        ["Where does Chocolate Milk come from?","Brown Cows","White Cows","Grey Cows","White cows with black spots"],
	        ...
	        ["If a fly has no wings would you call him a walk?","Yes","No, that's insulting","If he has walked","No, you call him a fly"],
		...
		<?php }	else if ($_GET["type"]=="extend") { ?>
			/*0*/["This is not yet done (wait a week). Would you like to continue?"],
            ["What is sin(pi)","1","2","0","1/2","-1"],//0
	        ["What is the average IQ","1","100","110","Varies by Country"],//100
	        ["How many letters are in my name?","4","my name","6","my Daniel"],//6
	        ["How hot is the average guy","97.8","98.6","5/10","10/10","I'm straight"],//98.6
	        /*5*/["What color are interstate shields?","Red","Blue","White","All of the above"],//all
	        ["What was the NMSL","National Maximum Sales Legislation","New Metric for Standard Law","National Maximum Speed Law","No Men See Ladies"],//Speed
	        ["What flavor is the sky?","Multiple","Blue","Purple","Unicorn","Red"],//multiple
	        ["How is the sky blue?","Refraction","Reflection","Scattering","Reduction","Food Crying"],//scattering
	        ["What is forward backward?","backward","drawrof","Backwards Forwards","Stationary","darwrof"],//drawrof
		<?php }	else if ($_GET["type"]=="comp") { ?>
			/*0*/["What is windows 10's minimum ram usage?","1GB","2GB","4GB","8GB"],
			...
			["What is the average HDD RW speed?","500RPM","7200RPM","15000RPM","120RPS"],//both 7200 and 120
		...
		<?php }	else if ($_GET["type"]=="spokane") { ?>
	        ...
	        ["How many times did the Spokane Shock win a championship?","12","1","5","9","0"],//12 or 5
	        ...
	        /*15*/["What Major Highways run North and South in Spokane?","US 2, US 395","US 195, US 2","I-90, US 195","US 2, I-90","US 195, US 395"],//US 195, US 395
	        ["How many letters are in Spokane?","6","7","8","9","It doesn’t have any letters"],//7
	        ["What year was the Monroe Street Bridge constructed?","1898","1907","1911","1912","1923"],//1911
	        ["By what means was Expo ’74 paid for through?","Taxes","Grants","Shady Business Deals","Outside Investors"],//Shady Business Deals
	        ["What was Riverfront Park originally?","A railyard","A shipping center","A hydroelectric plant","An unusual thing","A train station"],//A railyard
	        /*20*/["What was originally done where Riverpark Square Mall is now?","Court","Jailing","Eating at Restaurants","Executions"],//Executions
	        ["What is special about the Spokane County Court House?","The Design","The number of Courtrooms","The Size"],//The Design
	        ["Who is the mayor of Spokane?","Mary Verner","Cathy McMorris Rodgers","David Condon","Al French"],//David Condon
		<?php } ?>
    ];
